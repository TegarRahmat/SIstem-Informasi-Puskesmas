...
class PasienController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				pasien.username LIKE ? OR 
				pasien.nama_pasien LIKE ? OR 
				pasien.alamat LIKE ? OR 
				pasien.jk LIKE ? OR 
				pasien.umur LIKE ? OR 
				pasien.no_telp LIKE ? OR 
				pasien.password LIKE ? OR 
				pasien.foto LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","nama_pasien","alamat","jk","umur","no_telp","password","foto");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_pasien","username","nama_pasien","alamat","jk","umur","no_telp","password","foto");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
