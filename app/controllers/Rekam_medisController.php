 ...
 * @category  Controller
 */
class Rekam_medisController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				rekam_medis.keterangan LIKE ? OR 
				rekam_medis.tanggal_berobat LIKE ? OR 
				rekam_medis.id_pasien LIKE ? OR 
				rekam_medis.id_dokter LIKE ? OR 
				rekam_medis.id_poli LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("keterangan","tanggal_berobat","id_pasien","id_dokter","id_poli");
			...
			$this->sanitize_array = array(
				...
				'tanggal_berobat' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_rekam_medis","keterangan","tanggal_berobat","id_pasien","id_dokter","id_poli");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'keterangan' => 'required',
