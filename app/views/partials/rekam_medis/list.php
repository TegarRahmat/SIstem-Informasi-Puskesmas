                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tanggal_berobat"> Tanggal Berobat</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id_rekam_medis"><a href="<?php print_link("rekam_medis/view/$data[id_rekam_medis]") ?>"><?php echo $data['id_rekam_medis']; ?></a></td>
                                                    ...
                                                    <td class="td-tanggal_berobat">
                                                        <span  data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                            data-value="<?php echo $data['tanggal_berobat']; ?>" 
                                                            data-pk="<?php echo $data['id_rekam_medis'] ?>" 
                                                            data-url="<?php print_link("rekam_medis/editfield/" . urlencode($data['id_rekam_medis'])); ?>" 
                                                            data-name="tanggal_berobat" 
                                                            data-title="Enter Tanggal Berobat" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
